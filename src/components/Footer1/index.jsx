        ...
        <div className="flex flex-col items-center justify-center w-full">
          <div className="flex flex-row justify-center items-center w-full pt-8 pb-[31px] gap-[498px] border-white-A700_3f border-b border-solid">
            ...
            <div className="flex flex-col items-start justify-start w-[26%] gap-1.5">
              ...
              <div className="flex flex-row justify-start gap-4">
                ...
                <Img src="images/img_download_app_store.png" alt="downloadappone" className="w-[48%] object-cover" />
              </div>
            </div>
          </div>
          <div className="flex flex-row justify-between items-start w-full mt-8">
            <div className="flex flex-col items-center justify-start w-[22%] gap-8">
              <Img src="images/img_logo_white_a700.svg" alt="logothreeone" className="h-12" />
              <div className="flex flex-col items-start justify-start w-[96%] gap-[15px]">
                <Text size="md" as="p" className="text-center">
                  About Us
                </Text>
                <div className="flex flex-row justify-between w-full">
                  <Img src="images/img_ic_baseline_whatsapp.svg" alt="icbaselineone" className="h-8 w-8" />
                  <Img src="images/img_mdi_instagram.svg" alt="mdiinstagram" className="h-8 w-8" />
                  <Img src="images/img_mdi_linkedin.svg" alt="mdilinkedinone" className="h-8 w-8" />
                  <Img src="images/img_ic_baseline_facebook.svg" alt="icbaselineone" className="h-8 w-8" />
                  <Img src="images/img_mdi_youtube.svg" alt="mdiyoutubeone" className="h-8 w-8" />
                  <Img src="images/img_mdi_twitter.svg" alt="mditwitterone" className="h-8 w-8" />
                </div>
              </div>
            </div>
